...
export const addData = (dataInfo) => {
    ...
    return async (dispatch) => {
        ...
        const res = await axios.post("http://127.0.0.1:2707/add_data", {
            ...dataInfo,
        });
        console.log(res);
        if(res.status === 201){
...
export const mineBlock = () => {
    return async (dispatch) => {
        ...
        const res = await axios.get("http://127.0.0.1:2707/mine_block");
        if(res.status === 200){
            console.log(res);
...
export const getCreditData = () => {
    return async (dispatch) => {
        ...
        const res = await axios.get("http://127.0.0.1:2707/get_creditData")
...
export const getOrgTrans = (transactions) => {
    ...
    return async (dispatch) => {
        ...
        const res = await axios.post("http://127.0.0.1:2707/get_orgTrans",{
            ...transactions,
        } );
        console.log(res);
        if(res.status === 201){
