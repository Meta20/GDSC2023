...
const Header = (props) => {
   ...
   const logout =()=>{
    ...
    const forLoggedInUser = () => {
        ...
        <nav>
            <ul>
                <li><Link to={`/${auth.user.contractAddress}/dashboard`}>Home</Link></li>
                <li><Link to={`/${auth.user.contractAddress}/orgform`}>Input</Link></li>
                <li><Link to={`/${auth.user.contractAddress}/approve`}>Approve</Link></li>
